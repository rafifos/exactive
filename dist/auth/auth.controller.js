...
let AuthController = class AuthController {
    ...
    signUp(authCredentialsDto) {
        this.logger.verbose(`Creating a new User with params: ${JSON.stringify(omit(authCredentialsDto, 'password'))}`);
        return this.authService.signUp(authCredentialsDto);
    }
    signIn(authCredentialsDto) {
        this.logger.verbose(`Signing-in User: ${JSON.stringify(omit(authCredentialsDto, 'password'))}`);
